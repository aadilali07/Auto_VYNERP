...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AutovynModules/AUTOVYN.Master" CodeBehind="discount_report.aspx.vb"  Inherits="AutovynERP.discount_report" %>
    ...
    <div class="container-fluid main-section">
        ...
        <div class="row status-section">
            <div class="col-12">
                   ...
                   <asp:Label ID="Label3" CssClass="col-sm-1 col-form-label" runat="server" Text="Report"></asp:Label>
                    <div class="col-sm-2">
                        <asp:DropDownList ID="appr_status" CssClass="form-control" runat="server">
                            ...
                            <asp:ListItem Value="C">Consumer Discount</asp:ListItem>
                            <asp:ListItem Value="Co">Corp. Discount</asp:ListItem>
                            <asp:ListItem Value="E">Exchange Discount</asp:ListItem>
                        </asp:DropDownList>
                    </div>
             ...
             <div class='popup'>
                 <h5 align="center">Discount Graph <label class="br_name"></label></h5>
        ...
        $(function () {
           ...
           <script>
               ...
               $("tr").click(function () {
                   ...
                   var type_sts = $('#ContentPlaceHolder1_appr_status').val();


                   $.ajax({
                       type: "POST",
                       url: "discount_report.aspx/GetChartData",
                       data: "{cellValue: '" + cellValue + "',frm_year: '" + frm_year + "',to_year: '" + to_year + "',type_sts: '" + type_sts + "'}",
