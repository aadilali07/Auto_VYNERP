...
Public Class ccp
    ...
    Private Sub location_Data()
        Try
            ...
            TranDt = con.ReturnDtTable("SELECT month(icm_mst.inv_date)as Mnth,icm_mst.loc_code, PPC_Chrgs FROM icm_mst JOIN icm_dtl ON icm_mst.tran_id = icm_dtl.tran_id  where icm_mst.INV_DATE BETWEEN '" & Year_From.Text & "-04-01' AND '" & Year_To.Text & "-03-31' GROUP BY icm_mst.inv_date , icm_mst.Loc_Code,icm_dtl.PPC_Chrgs")
            ...
            For i As Integer = 0 To BrDt.Rows.Count - 1
                ...
                If dtrow.Length > 0 Then
                    ...
                    dt.Rows(dt.Rows.Count - 1)("Apr") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 4 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("May") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 5 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Jun") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 6 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Jul") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 7 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Aug") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 8 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Sep") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 9 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Oct") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 10 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Nov") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 11 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Dec") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 12 & "").ToString)

                    dt.Rows(dt.Rows.Count - 1)("Jan") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 1 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Feb") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 2 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Mar") = Val(TranDt2.Compute("count(PPC_Chrgs)", "Mnth=" & 3 & "").ToString)
        ...
        Try
            ...
            For i As Integer = 0 To BrDt.Rows.Count - 1
                ...
                If dtrow.Length > 0 Then
                    ...
                    dt.Rows(dt.Rows.Count - 1)("Apr") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 4 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("May") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 5 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Jun") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 6 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Jul") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 7 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Aug") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 8 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Sep") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 9 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Oct") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 10 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Nov") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 11 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Dec") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 12 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Jan") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 1 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Feb") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 2 & "").ToString)
                    dt.Rows(dt.Rows.Count - 1)("Mar") = Val(TranDt2.Compute("sum(PPC_Chrgs)", "Mnth=" & 3 & "").ToString)
                End If
            Next
    ...
    Public Shared Function GetChartData(cellValue As String, frm_year As String, to_year As String) As String
        ...
        Dim TranDt As DataTable
        TranDt = con.ReturnDtTable("SELECT month(icm_mst.inv_date)as Mnth,icm_mst.loc_code, PPC_Chrgs FROM icm_mst JOIN icm_dtl ON icm_mst.tran_id = icm_dtl.tran_id  where icm_mst.INV_DATE BETWEEN '" & frm_year & "-04-01' AND '" & to_year & "-03-31' GROUP BY icm_mst.inv_date , icm_mst.Loc_Code,icm_dtl.PPC_Chrgs")
