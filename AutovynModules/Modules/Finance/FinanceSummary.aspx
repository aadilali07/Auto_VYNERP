<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AutovynModules/AUTOVYN.Master" CodeBehind="FinanceSummary.aspx.vb" Inherits="AutovynERP.FinanceSummary" %>
            ...
            <div class="col-lg-12">
                ...
                <div class="container-fluid">
                    <div class="row mt-1 mb-1 amt-box">
                        ...
                        <asp:Label ID="Label1" Class="col-2 col-form-label amt-box-lbl" runat="server" Text="Cust Name/cust_id/dms_inv"></asp:Label>
