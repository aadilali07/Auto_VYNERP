<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BBND.aspx.vb" Inherits="AutovynERP.BBND" %>
...
<body>
    <form id="form1" runat="server">
        <div class="backbtn">
         ...
         <div class="w3-container">
            <div class="w3-bar w3-black tab">
               <a class="w3-bar-item w3-button" href="SalesModule.aspx"
        ...
        <asp:Panel ID="Panel1" runat="server" ScrollBars="Horizontal">
            <asp:GridView ID="BBNDData" runat="server"
